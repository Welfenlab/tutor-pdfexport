...
var toPdf = function(template, markdown, callback) {
  ...
  //require('fs').writeFileSync("/home/mklein/Development/tutor-meta/tutor-slave/template-instance.html", html);

  conversion({
      html: html,
      header: "",
      footer: "",
      printDelay: 1000,//time in ms to wait before printing into pdf
